...
class TrackMAP(_BaseMetric):
    ...
    def get_default_metric_config():
        ...
        default_config = {
            ...
            'IOU_THRESHOLDS': [0.5],  # np.arange(0.5, 0.96, 0.05),  # the IoU thresholds
            ...
            'MAX_DETECTIONS': 300,  # limit the maximum number of considered tracks per sequence (0 for unlimited)
            'PRINT_CONFIG': True
        }
